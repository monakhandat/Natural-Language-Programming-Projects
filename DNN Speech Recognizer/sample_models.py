...
def final_model(input_dim, units,filters, kernel_size, conv_stride,
    ...
    for i in range(3):
        layer_name='rnn_'+str(i)
        simp_rnn = GRU(units, activation='relu',
                       return_sequences=True, implementation=2, name=layer_name)(bn_cnn)
        bn_rnn = BatchNormalization(name = 'bn_rnn_'+str(i))(simp_rnn)
    bidir_rnn_1 = Bidirectional(GRU(units, activation='relu', return_sequences=True, implementation=2, dropout_U=0.0,       name='bidir_rnn_1'),merge_mode="concat")(bn_rnn)
    dropout_bidir_rnn_1 = Dropout(0.0)(bidir_rnn_1)
    # Add batch normalization
    bn_bidir_rnn_1 = BatchNormalization(name="bn_bidir_rnn_1")(dropout_bidir_rnn_1)
    bidir_rnn_2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2,dropout_U=0.0,name='bidir_rnn_2'),merge_mode="concat")(bn_bidir_rnn_1)
    dropout_bidir_rnn_2 = Dropout(0.0)(bidir_rnn_2)
    bn_bidir_rnn_2 = BatchNormalization(name="bn_bidir_rnn_2")(dropout_bidir_rnn_2)
